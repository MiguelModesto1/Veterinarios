...
namespace Vets.Models {
   ...
   public class Donos {
     ...
     [RegularExpression("[A-ZÂÔÎa-záéíóúàèìòùâêîôûäëïöüãõç '-]")]
      ...
      [RegularExpression("[123578]+[0-9]{8}]", ErrorMessage = "O {0} deve começar por 1, 2, ,3 ,5, 7, 8")]
      ...
      /// </summary>
      [StringLength(1, ErrorMessage ="O {0} só aceita um caracter.")]
